...
public class ConfigurationServerImpl implements ConfigurationServer {
    ...
    */
    ...
    private ServiceOfferingVO createServiceOffering(long userId, String name, int cpu, int ramSize, int speed, String displayText, boolean localStorageRequired, boolean offerHA, boolean isDedicated, String tags) {
        tags = cleanupTags(tags);
        ServiceOfferingVO offering = new ServiceOfferingVO(name, cpu, ramSize, speed, null, null, offerHA, isDedicated, displayText, localStorageRequired, false, tags, false, null, false);
