...
//	UpgradeURL("Advanced", ManagementServer.class, String.class, "upgrade.url", "http://example.com:8080/client/agent/update.zip", "The upgrade URL is the URL of the management server that agents will connect to in order to automatically upgrade.", null),
	...
	ImplicitDedicationEnable("Advanced", ManagementServer.class, Boolean.class, "implicit.dedication.enable", "true", "Enable resource dedication", null),
    ...
    VmAllocationAlgorithm("Advanced", ManagementServer.class, String.class, "vm.allocation.algorithm", "random", "'random', 'firstfit', 'userdispersing', 'userconcentratedpod_random', 'userconcentratedpod_firstfit', 'dedicated' : Order in which hosts within a cluster will be considered for VM/volume allocation.", null),
