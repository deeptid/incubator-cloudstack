...
@ContextConfiguration(locations = "classpath:/dedicatedContext.xml")
public class DedicatedApiUnitTest {
    @Inject
    DedicatedResourceManagerImpl _dedicatedService;
    ...
    @Inject
    HostDao _hostDao;
    private static final org.apache.log4j.Logger s_logger = Logger
            .getLogger(DedicatedApiUnitTest.class);
    ...
    public void testSetUp() {
        ...
        when(
                _acctMgr.finalizeOwner((Account) anyObject(), anyString(),
    ...
    public void dedicateResourceInvalidDomainIDTest() {
        _dedicatedService.dedicateResource(10L, null, null, null, domainId,
                null, ResourceType.Zone);
    }

    @Test(expected = InvalidParameterValueException.class)
    public void dedicateResourceInvalidAccountIDTest() {
        _dedicatedService.dedicateResource(10L, null, null, null, domainId,
                accountId, ResourceType.Zone);
    }
    ...
    public void runDedicateZoneTest() {
        ...
        try {
            List<DedicatedResourceVO> result = _dedicatedService
                    .dedicateResource(10L, null, null, null, domainId,
                            accountId, ResourceType.Zone);
    ...
    public void runDedicatePodTest() {
        ...
        try {
            List<DedicatedResourceVO> result = _dedicatedService
                    .dedicateResource(null, 10L, null, null, domainId,
                            accountId, ResourceType.Pod);
            Assert.assertNotNull(result);
        } catch (Exception e) {
    ...
    public void runDedicateClusterTest() {
        ...
        try {
            List<DedicatedResourceVO> result = _dedicatedService
                    .dedicateResource(null, null, 10L, null, domainId,
                            accountId, ResourceType.Cluster);
            Assert.assertNotNull(result);
        } catch (Exception e) {
    ...
    public void runDedicateHostTest() {
        ...
        try {
            List<DedicatedResourceVO> result = _dedicatedService
                    .dedicateResource(null, null, null, 10L, domainId,
                            accountId, ResourceType.Host);
            Assert.assertNotNull(result);
        } catch (Exception e) {
    ...
    public void dedicateZoneExistTest() {
        ...
        _dedicatedService.dedicateResource(10L, null, null, null, domainId, accountId, ResourceType.Zone);
    }
    ...
    public void dedicatePodExistTest() {
        ...
        _dedicatedService.dedicateResource(null, 10L, null, null, domainId, accountId, ResourceType.Pod);
    }
    ...
    public void dedicateClusterExistTest() {
        ...
        _dedicatedService.dedicateResource(null, null, 10L, null, domainId, accountId, ResourceType.Cluster);
    }
    ...
    public void dedicateHostExistTest() {
        ...
        _dedicatedService.dedicateResource(null, null, null, 10L, domainId, accountId, ResourceType.Host);
    }
