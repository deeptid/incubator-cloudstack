...
public class DedicatedApiUnitTest {
    ...
    public void InvalidDomainIDForAccountTest() {
        _dedicatedService.dedicateZone(10L, domainId, 20L);
    }

    @Test(expected = InvalidParameterValueException.class)
    public void dedicateResourceInvalidAccountIDTest() {
        _dedicatedService.dedicateZone(10L, domainId, accountId);
    }
    ...
    public void runDedicateZoneTest() {
        ...
        try {
            List<DedicatedResourceVO> result = _dedicatedService.dedicateZone(10L, domainId, accountId);
    ...
    public void runDedicatePodTest() {
        ...
        try {
            List<DedicatedResourceVO> result = _dedicatedService.dedicatePod(10L, domainId, accountId);
            Assert.assertNotNull(result);
        } catch (Exception e) {
    ...
    public void runDedicateClusterTest() {
        ...
        try {
            List<DedicatedResourceVO> result = _dedicatedService.dedicateCluster(10L, domainId, accountId);
            Assert.assertNotNull(result);
        } catch (Exception e) {
    ...
    public void runDedicateHostTest() {
        ...
        try {
            List<DedicatedResourceVO> result = _dedicatedService.dedicateHost(10L, domainId, accountId);
            Assert.assertNotNull(result);
        } catch (Exception e) {
    ...
    public void dedicatePodExistTest() {
        ...
        _dedicatedService.dedicatePod(10L, domainId, accountId);
    }
    ...
    public void dedicateClusterExistTest() {
        ...
        _dedicatedService.dedicateCluster(10L, domainId, accountId);
    }
    ...
    public void dedicateHostExistTest() {
        ...
        _dedicatedService.dedicateHost(10L, domainId, accountId);
    }
