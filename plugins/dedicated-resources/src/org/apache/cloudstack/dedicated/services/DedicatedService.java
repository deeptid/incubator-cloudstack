...
public interface DedicatedService extends PluggableService{
    ...
    List<DedicatedResourceVO> dedicateZone(Long zoneId, Long domainId, Long accountId, String accountName);

    List<DedicatedResourceVO> dedicatePod(Long podId, Long domainId, Long accountId, String accountName);

    List<DedicatedResourceVO> dedicateCluster(Long clusterId, Long domainId,
            Long accountId, String accountName);

    List<DedicatedResourceVO> dedicateHost(Long hostId, Long domainId,
            Long accountId, String accountName);
