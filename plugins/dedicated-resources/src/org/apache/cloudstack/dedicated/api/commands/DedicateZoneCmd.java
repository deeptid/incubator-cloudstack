...
public class DedicateZoneCmd extends BaseAsyncCmd {
    ...
    @Parameter(name=ApiConstants.ACCOUNT_ID, type=CommandType.UUID, entityType=AccountResponse.class, description="the ID of the containing account, null for domain specific zone")
    ...
    @Override
    public void execute(){
        List<? extends DedicatedResources> result = dedicatedService.dedicateZone(getZoneId(), getDomainId(), getAccountId(), getAccountName());
