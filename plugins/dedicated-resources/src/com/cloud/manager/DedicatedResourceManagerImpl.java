...
public class DedicatedResourceManagerImpl implements DedicatedService {
    ...
    public List<DedicatedResourceVO> dedicateResource(Long zoneId, Long podId, Long clusterId, Long hostId, Long domainId, Long accountId, ResourceType type) {
        // verify parameters
        ...
        case Pod :
            ...
            if (pod == null) {
                ...
                if(dedicatedPod != null && dedicatedZoneOfPod != null) {
                    throw new CloudRuntimeException("Pod or its zone is already dedicated");
                }
            }
            break;
        case Cluster :
            ...
            if (cluster == null) {
                ...
                if(dedicatedCluster != null || dedicatedPodOfCluster != null || dedicatedZoneOfCluster != null) {
                    throw new CloudRuntimeException("Cluster or its zone/pod is already dedicated");
                }
            }
            break;
        case Host :
            ...
            if (host == null) {
                ...
                if(dedicatedHost != null || dedicatedClusterOfHost != null || dedicatedPodOfHost != null || dedicatedZoneOfHost != null) {
                    throw new CloudRuntimeException("Host or its zone/pod/cluster is already dedicated");
                }
            }
            break;
        default:
        ...
        txn.start();
        DedicatedResourceVO dedicatedResource = new DedicatedResourceVO(zoneId, podId, clusterId, hostId, null, null);
        try {
            if (domainId != null) {
