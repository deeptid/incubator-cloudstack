...
@APICommand(name = "releaseDedicatedHost", description="Release the dedication", responseObject=SuccessResponse.class)
public class ReleaseDedicatedHostCmd extends BaseCmd {
    ...
    @Override
    public void execute(){
        boolean result = _dedicatedservice.releaseDedicatedResource(null, null, null, getHostId());
        if (result) {
