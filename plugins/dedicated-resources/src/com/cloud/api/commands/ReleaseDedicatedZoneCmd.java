...
@APICommand(name = "releaseDedicatedZone", description="Release the dedication", responseObject=SuccessResponse.class)
public class ReleaseDedicatedZoneCmd extends BaseCmd {
    ...
    @Override
    public void execute(){
        boolean result = _dedicatedservice.releaseDedicatedResource(getZoneId(), null, null, null);
        if (result) {
