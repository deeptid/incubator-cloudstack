...
@APICommand(name = "releaseDedicatedCluster", description="Release the dedication", responseObject=SuccessResponse.class)
public class ReleaseDedicatedClusterCmd extends BaseCmd {
    ...
    @Override
    public void execute(){
        boolean result = _dedicatedservice.releaseDedicatedResource(null, null, getClusterId(), null);
        if (result) {
