...
@APICommand(name = "releaseDedicatedPod", description="Release the dedication", responseObject=SuccessResponse.class)
public class ReleaseDedicatedPodCmd extends BaseCmd {
    ...
    @Override
    public void execute(){
        boolean result = _dedicatedservice.releaseDedicatedResource(null, getPodId(), null, null);
        if (result) {
