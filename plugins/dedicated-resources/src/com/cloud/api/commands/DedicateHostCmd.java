...
public class DedicateHostCmd extends BaseAsyncCmd {
    ...
    @Override
    public void execute(){
        List<? extends DedicatedResources> result = _dedicatedservice.dedicateResource(null, null, null, getHostId(), getDomainId(), getAccountId(), ResourceType.Host);
