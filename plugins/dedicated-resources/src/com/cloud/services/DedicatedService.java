...
public interface DedicatedService extends PluggableService{
    ...
    List<DedicatedResourceVO> dedicateZone(Long zoneId, Long domainId, Long accountId);

    List<DedicatedResourceVO> dedicatePod(Long podId, Long domainId, Long accountId);
